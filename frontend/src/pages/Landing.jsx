...
const SERVICES = [
  ...
  },
  {
    ...
    body:
      "Independent Effective Licence Position (ELP) — built the way LMS would build it, before LMS does. Same forensic method across Microsoft, SAP, IBM and VMware. No surprises, no exposure.",
